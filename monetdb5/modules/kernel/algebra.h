...
mal_export str ALGcount_bat(wrd *result, const bat *bid);
mal_export str ALGcount_nil(wrd *result, const bat *bid, const bit *ignore_nils);
mal_export str ALGcount_no_nil(wrd *result, const bat *bid);
...
mal_export str ALGslice_wrd(bat *ret, const bat *bid, const wrd *start, const wrd *end);
mal_export str ALGslice_oid(bat *ret, const bat *bid, const oid *start, const oid *end);
mal_export str ALGsubslice_wrd(bat *ret, const bat *bid, const wrd *start, const wrd *end);
