...
int
OPTfastmcsImplementation(Client cntxt, MalBlkPtr mb, MalStkPtr stk, InstrPtr p)
{
	/*
	int i,k=1, limit, actions=0;	// *actions* records the number of successful changes to the code
	int *alias;
	Lifespan span;
